  ...
  Widget _buildMessage(Message message, bool isMe) {
    final Container msg =  Container(
      ...
      child: Column(
        ...
        children: [
          Text(message.time,style: TextStyle(color: Colors.blueGrey,fontSize:10.0,fontWeight:FontWeight.w500,),),
          SizedBox(height: 8.0,),
          Text(message.text,style: TextStyle(color: Colors.blueGrey,fontSize:14.0,fontWeight:FontWeight.w600,),),
        ],
      ),
    );
    if(isMe){
